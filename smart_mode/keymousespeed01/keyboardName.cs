...
namespace keymousespeed01
{
    class keyboardName
    {
        ...
        {
            /*
            System.Windows.Input.Keyboard.IsKeyDown(System.Windows.Input.Key.Return);
            ...
            System.Windows.Input.KeyboardCapabilities kc =
    ...
    */
        ...
        public static string getKeyboardName()
        {
            ...
            // http://stackoverflow.com/questions/28471864/how-to-check-programatically-if-keyboard-is-connected-or-not
             ...
             foreach (ManagementObject keyboard in searcher.Get())
                {
                    ...
                    {
                        returnMsg += keyboard.GetPropertyValue("Name").ToString();
                        // Console.WriteLine("KB Name: {0}", returnMsg);
                    }
                }
        ...
        // from: http://www.pinvoke.net/default.aspx/user32.getkeyboardlayoutname
        public static String getKeyboardLayout(string code = null)
        {
            if (code == null)
                code = GetLayoutCode();
